...
const uint16_t PROGMEM mouse_enable_left[] = {DE_S, DE_D, DE_F, COMBO_END};
const uint16_t PROGMEM mouse_enable_right[] = {DE_J, DE_K, DE_L, COMBO_END};
const uint16_t PROGMEM mouse_disable[] = {KC_WH_L, KC_WH_D, KC_WH_R, COMBO_END};
...
combo_t key_combos[] = {
  ...
  COMBO(mouse_enable_left, TG(L_MOUSE)),
  COMBO(mouse_enable_right, TG(L_MOUSE)),
  COMBO(mouse_disable, TG(L_MOUSE))
};
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
  ...
  [L_RGB]   = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_WH_U, KC_WH_D)},
